...
### 任务目标 GOAL ###
现在请您以《大语言模型原理与应用实践：基于监督学习进行微调 Supervised Learning & Fine-Tuning》为标题， 使用逻辑清晰、结构紧凑、简单易懂的专业的技术语言（章节标题要非常吸引读者），写一篇有深度有思考有见解的专业IT领域的技术博客文章。
...
with open("example_blog2.md", 'r') as f:
    example_blog2 = f.read()    
...
def completions(input_data: InputData):
    ...
    prompt = [
        ...
        {"role": "assistant", "content": example_blog2},
